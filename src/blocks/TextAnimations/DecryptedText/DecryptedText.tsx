...
export default function DecryptedText({
  ...
  useEffect(() => {
    ...
    interface RevealedSet extends Set<number> {}

    const getNextIndex = (revealedSet: RevealedSet): number => {
        ...
        setRevealedIndices((prevRevealed) => {
          if (sequential) {
            if (prevRevealed.size < text.length) {
                const nextIndex: number = getNextIndex(prevRevealed as RevealedSet);
  ...
  useEffect(() => {
    ...
    const observerCallback = (entries: ObserverEntry[]) => {
