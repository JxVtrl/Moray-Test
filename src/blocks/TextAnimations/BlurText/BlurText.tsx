...
import { useSprings, animated, easings as EasingFunction } from '@react-spring/web';
...
export const BlurText = ({
  ...
  const springs = useSprings(
    ...
    elements.map((_, i) => ({
      ...
      to: inView
        ? async (next: (step: AnimationStep) => Promise<void>) => {
      ...
      delay: i * delay,
      config: { easing: easing as (t: number) => number },
    })),
  );
